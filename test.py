...
class MyTest(unittest.TestCase):
    ...
    def open_file(pathFile):
        ...
        return out
    def testAuth(self):
        auth = Auth("http://services.test.sw.com.mx", None ,"david.reyes@sw.com.mx", "TEST2022")
        response = auth.authentication()
        self.assertTrue(self.expected == response.get_status())
    def testStamp(self):
        stamp = Stamp("http://services.test.sw.com.mx", None, "david.reyes@sw.com.mx", "TEST2022")
